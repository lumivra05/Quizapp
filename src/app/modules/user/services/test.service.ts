...
export class TestService {
  /*submitAnswers(data: { testId: any; userId: string; responses: { questionId: number; selectedOption: any; }[]; }) {
    throw new Error('Method not implemented.');
  }
  submitAnwers(data: { testId: any; userId: string; responses: { questionId: number; selectedOption: any; }[]; }) {
    throw new Error('Method not implemented.');
  }
  submitTest(data: { testId: any; userId: string; responses: { questionId: number; selectedOption: any; }[]; }) {
    throw new Error('Method not implemented.');
  }*/
